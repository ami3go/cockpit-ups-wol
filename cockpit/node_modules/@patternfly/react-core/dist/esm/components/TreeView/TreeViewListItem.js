...
useMemo }) => {
    ...
    const renderToggle = (randomId) => (_jsx(ToggleComponent, Object.assign({ className: css(styles.treeViewNodeToggle, hasDisabledToggleClass && styles.modifiers.disabled), onClick: (evt) => {
        ...
        } }, ((hasCheckbox || isSelectable) && { 'aria-labelledby': `label-${randomId}` }), (ToggleComponent === 'button' && { disabled: isToggleDisabled, type: 'button' }), { tabIndex: -1, children: _jsx("span", { className: css(styles.treeViewNodeToggleIcon), children: _jsx(RhMicronsCaretRightIcon, {}) }) })));
